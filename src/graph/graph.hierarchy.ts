...
export class HierarchyGraph extends GraphBase {
	...
	*/
	private static renderHierarchy(parentEl:d3Select.Selection<SVGGElement,any,SVGElement,any>, data:model.Node, conf:Config, treeWidth:number, nodeHeight:number) {
		...
		const textEl:d3.Selection<SVGTextElement, any, SVGElement, any> = nodeEl.append("text")
		...
		textEl.each( (d:d3.HierarchyPointNode<model.Node>,i:number,els:SVGTextElement[]|d3.ArrayLike<SVGTextElement>) =>{
